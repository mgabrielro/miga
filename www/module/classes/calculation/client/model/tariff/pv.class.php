<?php
    ...
    namespace classes\calculation\client\model\tariff;
    ...
    abstract class pv extends base {
         ...
         *
         * @param string $profession Profession of tariff
         *
         * @return string
         */
        ...
        public function get_tariff_feature() {
            //return ($this->data['tariff']['feature']) ? $this->data['tariff']['feature'] : [];
            return ($this->data['tariff']['features']) ? $this->data['tariff']['features'] : [];
        }
        ...
        public function get_customerfeedback() {
            return (isset($this->data['customerfeedback'])) ? $this->data['customerfeedback']: null;
        }
