<?php
    ...
    class client extends \shared\classes\calculation\client\client implements ServiceLocatorAwareInterface {
         ...
         * Get log manager
         *
         * @return \shared\classes\common\log_manager
         */
        public function get_log_manager() {
            return new \classes\register\logmanager();
        }
        ...
        public function get_calculationparameter($product_id, $id) {
            ...
            if ($calculationparameter_response->get_status_code() != 200) {
                throw new \shared\classes\common\exception\logic('Calculation parameter getting failed');
            }
         ...
         * Get pkv form
         *
         * @deprecated Use servicelocator classes\calculation\mclient\controller\pkv\form
         ...
         * Get pkv result
         *
         * @deprecated Use servicelocator classes\calculation\mclient\controller\pkv\result
         ...
         *
         * @deprecated Use servicelocator classes\calculation\mclient\controller\pkv\tariff_detail
         * @param array $parameters Result parameters
         * @param response $response Response
         * @return controllerstatus
         */
        ...
        public function handle_controller_pkv(\Zend\Http\Request $request, $default_controller = 'form') {
            ...
            $controller = isset($parameters['c24_controller']) ? trim($parameters['c24_controller']) : $default_controller;
            ...
            switch ($controller) {
                ...
                default :
                    ...
                    throw new \shared\classes\common\exception\argument('Invalid controller "' . $controller . '"');
        ...
        protected function validate_product_id($product_id) {
            ...
            if (!product_id_exists($product_id)) {
                throw new \rs_logic_exception('Given product_id (' . $product_id . ') not valid.');
            }
